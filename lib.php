 ...
 */
function callback_colours_uses_sections() {
    return true;
}
 ...
 * @return bool Returns true
 */
function callback_colours_load_content(&$navigation, $course, $coursenode) {
 ...
 * @return string
 */
function callback_colours_definition() {
    return get_string('topic');
}

function callback_colours_get_section_name($course, $section) {
 ...
 * @return stdClass
 */
function callback_colours_ajax_support() {
 ...
 */
function callback_colours_ajax_section_move($course) {
    global $COURSE, $PAGE;
